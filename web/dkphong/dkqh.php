...
$sql="SELECT * FROM phong Inner Join khachhang On phong.MaKH=khachhang.MaKH Inner Join phieudk On phieudk.MaKH = khachhang.MaKH where NOW() >DATE_ADD(NGAYDEN,INTERVAL 2 day) ORDER BY MaPhong ASC  limit $x,$sonews";
