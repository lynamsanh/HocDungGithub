...
xmlhttp2.onreadystatechange=function()
  ...
  if (xmlhttp2.readyState==4 && xmlhttp2.status==200)
    {
	    document.getElementById("nhan").innerHTML=xmlhttp2.responseText
    }
  }

xmlhttp2.open("GET","timkiem.php?nocache=+'nocache'&tim="+document.frmtim.tim.value,true);
xmlhttp2.send();
}
</script>
...
$sql="SELECT * FROM phong ORDER BY MaPhong ASC  limit $x,$sonews";
...
?>
<form name="frmtim" method="get" action="timkiem.php">
<div style='padding:5px; margin-top:40'>tim kiem <input type="text"  name="tim"  size="16" /><br />
